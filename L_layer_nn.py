...
def L_layer_model(X, Y, layers_dims, activation_functions, learning_rate = 0.1, num_iterations = 3000, print_cost=False, print_plot = False):
    """
